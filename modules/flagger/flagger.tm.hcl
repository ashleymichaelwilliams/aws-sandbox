...
# Generate '_terramate_generated_flagger.tf' in each stack
generate_hcl "_terramate_generated_flagger.tf" {
  content {
    ...
    resource "helm_release" "flagger" {
      namespace        = global.helm_chart_flagger.namespace
      create_namespace = true

      wait = true

      name       = global.helm_chart_flagger.releaseName
      repository = "https://flagger.app"
      chart      = "flagger"
      version    = global.helm_chart_flagger.version
