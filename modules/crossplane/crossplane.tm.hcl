...
# Generate '_terramate_generated_crossplane.tf' in each stack
generate_hcl "_terramate_generated_crossplane.tf" {
  content {
    ...
    resource "helm_release" "crossplane" {
      namespace        = global.helm_chart_crossplane.namespace
      create_namespace = true

      wait = true

      name       = global.helm_chart_crossplane.releaseName
      repository = "https://charts.crossplane.io/stable"
      chart      = "crossplane"
      version    = global.helm_chart_crossplane.version
